...
CREATE TABLE `wishlists` (
  ...
  KEY `userId` (`userId`),
  CONSTRAINT `wishlists_ibfk_33` FOREIGN KEY (`productId`) REFERENCES `products` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `wishlists_ibfk_34` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
