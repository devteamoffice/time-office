...
CREATE TABLE `orders` (
  ...
  KEY `cartId` (`cartId`),
  KEY `userId` (`userId`),
  CONSTRAINT `orders_ibfk_33` FOREIGN KEY (`cartId`) REFERENCES `carts` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `orders_ibfk_34` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON UPDATE CASCADE
