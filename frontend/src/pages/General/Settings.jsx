                    ...
                    <div class="tab-content mb-0">
                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="mb-3">
                                  <label class="form-label" for="basicFname">
                                    First Name
                                  </label>
                                  <input
                                    type="text"
                              ...
                              <div class="col-md-6">
                                <div class="mb-3">
                                  <label class="form-label" for="basicLname">
                                    Last Name
                                  </label>
                                  <input
                                    type="text"
                      ...
                      <div class="tab-pane" id="basictab3" role="tabpanel">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="mb-3">
                              <label for="basicGitLink" class="form-label">
                                GitHub
                              </label>
                              <input
                                id="basicGitLink"
                          ...
                          <div class="col-lg-6">
                            <div class="mb-3">
                              <label for="basicGoogleLink" class="form-label">
                                Google
                              </label>
                              <input
                                id="basicGoogleLink"
                          ...
                          <div class="col-lg-6">
                            <div class="mb-3">
                              <label for="basicSkypeLink" class="form-label">
                                Skype
                              </label>
                              <input
                                id="basicSkypeLink"
