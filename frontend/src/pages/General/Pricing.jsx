        ...
        <div class="col-12">
          <div class="text-center my-4">
            ...
            <p class="text-muted text-center">
              Get the power and control you need to manage your organization's
              ...
              <div class="card card-pricing">
                <div class="card-body">
                  ...
                  <h2 class="mt-0 mb-3 fw-bold">
                    $0 <span class="fs-14 fw-medium text-muted">/ Month</span>
                  </h2>
            ...
            <div class="col-lg-3">
              <div class="card card-pricing">
                <div class="card-body">
                  ...
                  <h2 class="mt-0 mb-3 fw-bold">
                    $19 <span class="fs-14 fw-medium text-muted">/ Month</span>
                  </h2>
            ...
            <div class="col-lg-3">
              <div class="card card-pricing">
                <div class="card-body">
                  ...
                  <h2 class="mt-0 mb-3 fw-bold">
                    $29 <span class="fs-14 fw-medium text-muted">/ Month</span>
                  </h2>
            ...
            <div class="col-lg-3">
              <div class="card card-pricing">
                <div class="card-body">
                  ...
                  <h2 class="mt-0 mb-3 fw-bold">
                    $49 <span class="fs-14 fw-medium text-muted">/ Month</span>
                  </h2>
