      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div
            ...
            style={{ backgroundImage: "assets/images/small/img-2.jpg" }}
          >
              ...
              <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                  ...
                  <div class="search-bar">
                    ...
                    <input
                      type="search"
                      class="form-control rounded-pill bg- border-0"
                      id="search"
                      placeholder="Search ..."
                    />
                  </div>
                    ...
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          or project during development or testing phases. They
                          help simulate the appearance and functionality of a
                          real FAQ section without requiring actual content.
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          details about your purchase and reason for the refund.
                          Our representatives will guide you through the
                          process.
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          within 30 days of purchase for eligible products or
                          services. Certain restrictions may apply, so it's
                          essential to review the terms and conditions specific
                          to your purchase.
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          and businesses to test the functionality of e-commerce
                          platforms, mobile apps, and payment gateways. They
                          help identify and resolve issues without risking real
                          transactions.
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          secure. However, it's crucial not to confuse them with
                          real transactions and avoid entering genuine financial
                          information.
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header">
                        <button
                          ...
                          aria-controls="faq9"
                        >
                          How can I differentiate between a Dummy Payment and a
                          real one?
                        </button>
                      </h2>
                  ...
                  <div class="accordion">
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          phone, or live chat. Our representatives are available
                          to assist you during business hours, Monday through
                          Friday.
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="accordion-item">
                      ...
                      <div id="faq12" class="accordion-collapse collapse">
                        <div class="accordion-body">
                          We strive to respond to all customer inquiries within
                          24 hours during regular business hours. Response times
                          may vary depending on the volume of inquiries
                          received.
                        </div>
                      </div>
                    </div>
              ...
              <div class="row my-5">
                <div class="col-12 text-center">
                  ...
                  <button type="button" class="btn btn-success mt-2">
                    <i class="bx bx-envelope me-1"></i> Email us your question
                  </button>
                  <button type="button" class="btn btn-info mt-2 ms-1">
                    <i class="bx bxl-twitter me-1"></i> Send us a tweet
                  </button>
                </div>
              </div>
            </div>
