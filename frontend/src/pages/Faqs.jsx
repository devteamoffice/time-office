    ...
    <section class="flat-spacing-11">
      <div class="container">
        <div class="tf-accordion-wrap d-flex justify-content-between">
          <div class="box">
            <div class="tf-accordion-link-list w-100 sticky-top radius-10 border-line">
              <div class="tf-link-item">
                <a
                  class="d-flex justify-content-between align-items-center line"
          ...
          <div class="content">
            <h5 id="shopping-information" class="mb_24">
              ...
              <div class="flat-toggle active">
                ...
                <div class="toggle-content">
                  <p>
                    ...
                    identify. Duis autem vel eum iriure dolor in hendrerit
                    vulputate velit esse molestie consequat, vel illum dolore eu
                    feugiat nulla facilisis. For me, the most important part of
                    improving at photography has been sharing it. Lorem ipsum
            ...
            <h5 id="payment-information" class="mb_24">
              Payment Information
            </h5>
            <div class="flat-accordion style-default has-btns mb_60">
              <div class="flat-toggle">
            ...
            <h5 id="order-returns" class="mb_24">
              Order Returns
            </h5>
