              ...
              <div class="row justify-content-center">
                <div class="col-lg-7 text-center   ">
                  ...
                  <div class="search-bar">
                    ...
                    <input
                      type="search"
                      class="form-control rounded-pill bg-white border-0"
                      id="search"
                      placeholder="Search ..."
                    />
                  </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0">
                ...
                with this policy. This Privacy Policy explains how we collect,
                use, disclose, and safeguard your information when you use our
                SaaS product, TechFusion Suite, available at www.techfusion.com
                (the "Site") or through our applications and services
