...
const TermCondition = () => {
  return (
    <>
      <section className="termcondition">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h2>Terms & Conditions</h2>
              <h4>Last updated on Oct 18th 2022</h4>
              <p>
              ...
              <p>
                ...
                privacy policy govern E-TIME OFFICE SOFTECH PRIVATE LIMITED''s
                relationship with you in relation to this website.
              </p>
              <p>
                The term 'E-TIME OFFICE SOFTECH PRIVATE LIMITED' or 'us' or 'we'
                refers to the owner of the website whose registered/operational
                office is B205, ANANNYA COMPLEX, OP ROAD, AKSHAR CHOWK Vadodara
                GUJARAT 390020. The term 'you' refers to the user or viewer of
                our website.
              </p>
              <h4>
              ...
              <ul>
                ...
                <li>
                  ...
                  or document without E-TIME OFFICE SOFTECH PRIVATE LIMITED’s
              ...
              <h5>
                Disclaimer: The above content is created at E-TIME OFFICE
                SOFTECH PRIVATE LIMITED's sole discretion. Razorpay shall not be
