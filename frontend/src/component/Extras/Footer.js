          ...
          <div class="row">
              ...
              <div class="footer-infor">
                ...
                <ul class="tf-social-icon d-flex gap-10">
                  ...
                  <li>
                    <a
                      href="#"
                      class="box-icon w_34 round social-tiktok social-line"
                    >
                      <i class="icon fs-14 icon-tiktok"></i>
                    </a>
                  </li>
                  <li>
                    <a
                      href="#"
                      class="box-icon w_34 round social-pinterest social-line"
                    >
                      <i class="icon fs-14 icon-pinterest-1"></i>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
              ...
              <ul class="footer-menu-list tf-collapse-content">
                ...
                <li>
                  <a href="faq-1.html" class="footer-menu_item">
                    FAQ’s
                  </a>
                </li>
                <li>
                  <a href="compare.html" class="footer-menu_item">
                    Compare
                  </a>
                </li>
                <li>
                  <a href="wishlist.html" class="footer-menu_item">
                    My Wishlist
                  </a>
                </li>
              </ul>
            ...
            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
              ...
              <ul class="footer-menu-list tf-collapse-content">
                ...
                <li>
                  <a href="our-store.html" class="footer-menu_item">
                    Visit Our Store
                  </a>
                </li>
                <li>
                  <a href="contact-1.html" class="footer-menu_item">
                    Contact Us
                  </a>
                </li>
                <li>
                  <a href="login.html" class="footer-menu_item">
                    Account
                  </a>
                </li>
              </ul>
