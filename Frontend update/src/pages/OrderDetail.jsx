                ...
                <div class="card-body">
                  <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    <div>
                      ...
                      <p class="mb-0">
                        Order / Order Details / #0758267/90 - April 23 , 2024 at
                        6:23 pm
                      </p>
                    </div>
                    <div>
                      ...
                      <div class="mb-2">
                        ...
                        <div class="ms-2 d-flex flex-wrap gap-2  align-items-center justify-content-between">
                          <div>
                            ...
                            <a
                              href="#!"
                              class="badge bg-light text-dark fw-normal  px-2 py-1 fs-13"
                            >
                              Order 1
                            </a>
                            <a
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="text-dark mb-1 fw-medium">
                Transaction ID :{" "}
                <span class="text-muted fw-normal fs-13"> #IDN768139059</span>
              </p>
              <p class="text-dark mb-0 fw-medium">
                Card Holder Name :{" "}
                <span class="text-muted fw-normal fs-13"> Gaston Lapierre</span>
              </p>
            </div>
          </div>
          <div class="card">
              ...
              <div class="mapouter">
                <div class="gmap_canvas">
                  <iframe
                    ...
                    marginheight="0"
                    marginwidth="0"
                    src="https://maps.google.com/maps?width=1980&amp;height=400&amp;hl=en&amp;q=University%20of%20Oxford&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                  ></iframe>
                </div>
              </div>
            </div>
