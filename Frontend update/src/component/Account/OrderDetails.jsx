                ...
                <div class="widget-content-tab">
                      ...
                      <ul class="timeline">
                        <li>
                          ...
                          <div class="timeline-box">
                            ...
                            <p>
                              <strong>Courier Service : </strong>FedEx World
                              Service Center
                            </p>
                            <p>
                  ...
                  <div class="widget-content-inner">
                    <div class="order-head">
                      ...
                      <div class="content">
                        ...
                        <div class="mt_4">
                          <span class="fw-6">Price :</span> $28.95
                        </div>
                        <div class="mt_4">
                          <span class="fw-6">Size :</span> XL
                        </div>
                      </div>
                    </div>
                    <ul>
                  ...
                  <div class="widget-content-inner">
                    <p>
                      ...
                      your needs. Whether you're sending documents, parcels, or
                      larger shipments, our team ensures that your items are
                      handled with the utmost care and delivered on time. With a
                      commitment to customer satisfaction, real-time tracking,
                      and a wide network of routes, we make it easy for you to
                      send and receive packages both locally and
                      internationally. Choose our service for a seamless and
                      efficient delivery experience.
                    </p>
                  </div>
                  <div class="widget-content-inner">
                    <p class="text-2 text_success">
                    ...
                    <ul class="mt_20">
                      ...
                      <li>
                        Date : <span class="fw-7"> 17/07/2024, 02:34pm</span>
                      </li>
                      <li>
                      ...
                      <li>
                        Payment Methods :{" "}
                        <span class="fw-7">Cash on Delivery</span>
                      </li>
                    </ul>
                  </div>
                </div>
