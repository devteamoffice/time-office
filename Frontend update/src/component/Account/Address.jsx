          ...
          <div class="col-lg-9">
            <div class="my-account-content account-address">
              <div class="text-center widget-inner-address">
                ...
                <form
                  class="show-form-address wd-form-address"
                  id="formnewAddress"
                  action="#"
                >
                  ...
                  <div class="box-field">
                    <label
                      for="country"
                      class="mb_10 fw-4 text-start d-block text_black-2 "
                    >
                      Country/Region
                    </label>
                  ...
                  <div class="box-field text-start">
                    <div class="box-checkbox fieldset-radio d-flex align-items-center gap-8">
                      <input
                        ...
                        class="tf-check"
                      />
                      <label for="check-new-address" class="text_black-2 fw-4">
                ...
                <form
                  class="edit-form-address wd-form-address"
                  id="formeditAddress"
                  action="#"
                >
